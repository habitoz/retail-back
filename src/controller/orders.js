...
class OrdersController extends Controller {
    ...
    async getProductsReport(req, res) {
        const response = await orders_service.getProductsReport(req.user, req.query);
        return res.status(response.statusCode).send(response)
    }
    async getProductsListReport(req, res) {
        const response = await orders_service.getProductsListReport(req.user, req.query);
        return res.status(response.statusCode).send(response)
    }
    async getOrdersReport(req, res) {
        const response = await orders_service.getOrdersReport(req.user, req.query);
        return res.status(response.statusCode).send(response)
    }
    async getCahersOrderReport(req, res) {
        const response = await orders_service.getCahersOrderReport(req.query);
        return res.status(response.statusCode).send(response)
    }
